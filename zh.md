...
$ ezpack --help
  ...
  Options:
    ...
    -c, --config <file>     default config will be install user directory in ~.ezpack/config.json //指定配置文件执行命令,默认配置文件在user目录下
    ...
    -m, --map               enable js source map//产生调试文件
    -d, --debug             enable un-uglify js//产生非混淆debug文件
